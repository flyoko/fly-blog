...
const basicConfig = {
	...
	favicon: 'https://flyovo.cc.cd/media/public/profile/917a55b1-a628-406b-8bdf-76a0a8ad81fa.gif',
	language: 'zh-CN',
...
const blogConfig = {
	...
	twikoo: {
		...
		script: 'https://cdnjs.snrat.com/ajax/libs/twikoo/1.7.13/twikoo.min.js',
	},
}
