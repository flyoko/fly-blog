...
describe('public blog presentation', () => {
	...
	it('keeps the desktop shell compact and sticky content below the top navigation', () => {
		...
		expect(navBrand).toContain('<BlogShinchanScene variant="header" />')
		expect(navBrand).toContain('nav-brand-scene-scan')
		expect(navBrand).toContain('nav-brand-scene-line')
